...
- **Frontend**: **Dashboard**, **projects** list, project **surface preview** + **`/projects/{id}/surface`** (filters, CSV/JSON export), **hypotheses**, **findings**, **evidence**; richer analyst workflows (drawers) still open.
