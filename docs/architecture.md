...
- **Web**: Next.js App Router; **production image** uses standalone output. Browser calls API via `NEXT_PUBLIC_API_BASE_URL` (Compose defaults to host port **30880**). Minimal UI: **dashboard**, **projects** (create + list), **surface inventory**, **hypotheses** (drawer; approve / reject), **findings** (filters, export, drawer), **evidence** (presign upload; filters, export).
