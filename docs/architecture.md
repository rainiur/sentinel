...
- **Web**: Next.js App Router; **production image** uses standalone output. Browser calls API via `NEXT_PUBLIC_API_BASE_URL` (Compose defaults to host port **30880**). Minimal UI: **projects** (create + list), **surface**, **hypotheses** (generate / approve / reject), **findings**, **evidence** register/list.
