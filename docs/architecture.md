...
- **Web**: Next.js App Router; **production image** uses standalone output. Browser calls API via `NEXT_PUBLIC_API_BASE_URL` (Compose defaults to host port **30880**). Minimal UI: **dashboard**, **projects** (create + list), **surface inventory** (`/projects/{id}/surface`), **hypotheses** (generate / approve / reject), **findings**, **evidence** register/list.
